    ...
    async def seed_demo(request: Request):
        ...
        async with session_maker() as session:
            ...
            if result.scalar_one_or_none() is not None:
                ...
                return APIResponse(status="ok", message="Demo data already seeded")
        ...
        from app.schemas.common import APIResponse
        return APIResponse(
            status="ok", message="Demo data seeded",
            data={
                "users": [
                    {"username": "patient", "password": "demo"},
                    {"username": "pharmacist", "password": "demo"},
                    {"username": "doctor", "password": "demo"},
                    {"username": "driver", "password": "demo"},
